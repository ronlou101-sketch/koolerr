...
## PR #40 — verified historical / merged fact (path append only; not Phase 9 product completion)

| PR      | Merge      | Record                                                                                                                    |
| ------- | ---------- | ------------------------------------------------------------------------------------------------------------------------- |
| **#40** | `29bb21c…` | feat(academy): include campaign-architect on marketer onboarding path — append-only; founder/operator unchanged |

Verified `origin/master` tip at this slice start: **`29bb21c3bafaa84362d6b39be389ad81f13c55ea`**.

Marketer-path append only. Phase 9 is **not complete**. Phase 8 remains
**DEFERRED/HELD**; live-provider **unresolved / not closed**.
...
| PR      | Merge      | Record                                                                                                      |
| ------- | ---------- | ----------------------------------------------------------------------------------------------------------- |
| **#41** | `61291eb…` | feat(academy): add Phase 9 hermetic Billing catalog course — one static 5-lesson course + `catalog-coverage.test.ts` |

Verified `origin/master` included this merge before PR **#43**. `ONBOARDING_PATHS`
left unchanged in that PR. Phase 9 is **not complete**. Phase 8 remains
**DEFERRED/HELD**; live-provider **unresolved / not closed**.

---

## PR #43 — verified historical / merged fact (ops docs only; not Phase 9 product completion)

| PR      | Merge      | Record                                                                                         |
| ------- | ---------- | ---------------------------------------------------------------------------------------------- |
| **#43** | `5697b24…` | docs: Lean Phase 9 Foreman operating instructions only — `AGENT_OPERATING_INSTRUCTIONS.md` append |

Verified `origin/master` tip at this slice start: **`5697b24f328407945c9a42de7a292be6dcf759bc`**.

Lean ops docs only. Does **not** mark Phase 9 complete. Does **not** activate AMG.
Phase 8 remains **DEFERRED/HELD**; live-provider **unresolved / not closed**.
...
## PR #45 — verified historical / merged fact (path append only; not Phase 9 product completion)

| PR      | Merge      | Record                                                                                                                    |
| ------- | ---------- | ------------------------------------------------------------------------------------------------------------------------- |
| **#45** | `ebe2581…` | feat(academy): include billing on founder onboarding path — append-only; marketer/operator unchanged |

Verified `origin/master` tip at this slice start: **`ebe25818fac0fb1b252f0928e59ff276c1186646`**.

Founder-path billing append only. Phase 9 is **not complete**. Phase 8 remains
**DEFERRED/HELD**; live-provider **unresolved / not closed**.
...
## PR #47 — verified historical / merged fact (docs-only scope-lock; not Phase 9 product completion)

| PR      | Merge      | Record                                                                                         |
| ------- | ---------- | ---------------------------------------------------------------------------------------------- |
| **#47** | `ad775a7…` | docs(academy): record Phase 9 scope-lock and gap deferrals — O14 design-lock; not product work |

Verified `origin/master` tip at this slice start: **`ad775a7d603938c948d79a24c3722266b06cf1ef`**.

Docs-only O14 scope-lock. Phase 9 is **not complete**. Phase 8 remains
**DEFERRED/HELD**; live-provider **unresolved / not closed**.
...
**AMG** still **parked / NOT ACTIVATED**. Gate #2 still definition-only / not
operational; owner **TBD**. Temporary Foreman QA ≠ Independent QA. **PR #1**
remains **OPEN** untouched. **C2–C7** unresolved.
