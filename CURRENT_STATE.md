...
| **PR #31** | **OPEN** | SoT micro-reconcile after #30 + stale closes. **Noted** as overlapping/stale vs verified master tip `a12a097…` (predates #32/#33/#34). **Disposition unchanged** — no close/supersede/merge decision in this SoT. |
...
| `docs/status.json` | Machine-readable tracker; shape `{ completed, current, remaining }`. Tip reconciled to `a12a097…` / PR #34. Still retains older parallel “CURRENT” / Phase 8–10 complete strings — non-binding for “what is next” under C1 Version A. |
