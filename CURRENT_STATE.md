...
| **PR #31** | **OPEN** | SoT micro-reconcile after #30 + stale closes. **Noted** as overlapping/stale vs verified master tip `67b9ba5…` (predates #32/#33/#34/#35). **Disposition unchanged** — no close/supersede/merge decision in this SoT. |
...
| --- | --- |
| `README.md` / `CLAUDE.md` | **Binding under Founder-resolved C1 Version A (PR #21) + Founder override 2026-09-12:** Phase 7 complete; Phase 8 **DEFERRED/HELD** (not complete / not closed); Phase 9 Academy Catalog Search Foundation (Hermetic) is the approved next **docs/spec** slice — **not complete**. |
| `docs/status.json` | Machine-readable tracker; shape `{ completed, current, remaining }`. Tip reconciled to `67b9ba5…` / PR #35. Still retains older parallel “CURRENT” / Phase 8–10 complete strings — non-binding for “what is next” under C1 Version A. Historical `completed[]` Phase 8/9 strings are **not** authority. |
