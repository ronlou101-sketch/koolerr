...
export const PLATFORM_NAV_ITEMS: NavItem[] = [
  { href: '/cto', label: 'CTO Agent', primary: true, founderOnly: true },
  ...
  { href: '/revenue', label: 'Revenue', founderOnly: true },
  { href: '/mission-control', label: 'Mission Control', founderOnly: true },
