...
const PLANS = [
  {
    ...
    features: [
      ...
      '20 AI Marketing Assets / Month',
      'Up to 5 AI Spokesperson Videos / Month',
      '10 Minutes of AI Spokesperson Video Production / Month',
  ...
  },
  {
    ...
    features: [
      ...
      '100 AI Marketing Assets / Month',
      'Up to 30 AI Spokesperson Videos / Month',
      '60 Minutes of AI Spokesperson Video Production / Month',
  ...
  },
  {
    ...
    badge: null,
    features: [
      'Up to 200 AI Workforce Employees',
      '500 AI Marketing Assets / Month',
      'Up to 100 AI Spokesperson Videos / Month',
      '200 Minutes of AI Spokesperson Video Production / Month',
...
const COMPARISON_ROWS = [
  { feature: 'AI Workforce Employees', build: 'Up to 10', grow: 'Up to 50', scale: 'Up to 200' },
  { feature: 'AI Marketing Assets / month', build: '20', grow: '100', scale: '500' },
  {
    feature: 'AI Spokesperson Videos / month',
    build: 'Up to 5',
    grow: 'Up to 30',
    scale: 'Up to 100',
  },
  { feature: 'Spokesperson Video Minutes / month', build: '10', grow: '60', scale: '200' },
      ...
      <section className="bg-foreground py-20 text-background sm:py-28">
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              href="/api/checkout/start?plan=grow"
