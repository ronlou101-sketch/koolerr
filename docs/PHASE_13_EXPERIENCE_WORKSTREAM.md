...
| **B** | Review as a primary destination + live badge   | 🔄 **Current**                                | Promote Review from "More" into the primary nav bar with a live pending-count badge, per the locked nav spec (`Home · Campaigns · Deliverables · Review(badge) · Learn`). Surfaces "does my employee need anything from me?" without the customer hunting for it. Not yet started — awaiting founder approval of the first implementation task. |
...
**Slice A complete and approved. Slice B is the current phase.** No Slice B code has been written;
the recommended first implementation task is pending founder approval.
